...
%\usepackage{tensor}       % tensor notation  \indices  (disabled: conflicts with \tensor macro below)
...
%% Allow line-breaks after underscores in this table (reduces overfull hboxes)
\renewcommand{\_}{\textunderscore\allowbreak}%
\small%
\setlength{\emergencystretch}{3em}%
\begin{longtable}{p{4.5cm} p{3.0cm} p{6.8cm}}
  \toprule
...
\end{longtable}
%% Restore defaults changed for the API table above
